...
# from omni.isaac.core.prims import XFormPrim, XFormPrimView  # RigidPrimView, RigidPrim
from omni.isaac.core.prims import SoftPrim, SoftPrimView
...
class SoftObject:
    ...
    * Storing data related to the rigid object.
    ...
    objects: SoftPrimView  # RigidPrimView
    ...
    def spawn(self, prim_path: str, translation: Sequence[float] = None, orientation: Sequence[float] = None):
        ...
        SoftPrim(prim_path=prim_path)
        # -- set rigid body properties
        kit_utils.set_nested_rigid_body_properties(prim_path, **self.cfg.soft_props.to_dict())
        # apply collision properties
        # kit_utils.set_nested_collision_properties(prim_path, **self.cfg.collision_props.to_dict())  # soft
    ...
    def initialize(self, prim_paths_expr: Optional[str] = None):
        ...
        self.objects = SoftPrimView(prim_paths_expr, reset_xform_properties=False)
